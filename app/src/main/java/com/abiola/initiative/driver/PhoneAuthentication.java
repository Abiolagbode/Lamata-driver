...
public class PhoneAuthentication extends AppCompatActivity implements SuperTask.TaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mobnum.matches("^(09)\\d{9}$")) {
            mobnum_txt_vw.setText("+234 " + mobnum.substring(1));
            mobnum = "+234" + mobnum.substring(1);
        } else if(mobnum.matches("^(\\+234)\\d{9}$")) {
            mobnum_txt_vw.setText(mobnum = "+234 " + mobnum.substring(3));
            mobnum = "+234" + mobnum.substring(3);
        }
